                ...
                <div class="scroll-table" style="height: 400px;">
                    <table>
                        <tr>
                         ...
                         <tr class="td-row" v-for='prov in allProvider' :key='prov' @click='e => selectProviders(e.target, prov)'>
                            <td class='inn_td'>{{ prov.inn }}</td>
                            <td>{{ prov.name }}</td>
                        </tr>
                         <tr v-for='prov in 20' :key='prov'>
                            <td class='inn_td'>...</td>
                            <td>...</td>
                        </tr>
                    </table>
...
export default {
  ...
  methods: {
    ...
    selectProviders(tr, prov) {
      if(this.tr)
        this.tr.classList.remove('tr-select')
      this.tr = tr 
      this.tr.classList.add('tr-select')
      this.provider = prov
    },
    addProvider() {
