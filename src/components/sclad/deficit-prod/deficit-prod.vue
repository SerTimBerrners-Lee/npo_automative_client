      ...
      <div style='margin-left: 5px;'>
        <table>
          ...
          <tr v-for='cbed of allCbed' :key='cbed' 
            ...
            <td class='center min_width-100'>{{ cbed?.min_remaining || 0 }}</td>
            <td class='center min_width-100'>{{ cbed.shipments_kolvo * 3 }}</td>
          ...
          <tr v-for='detal of allDetal' :key='detal' 
            ...
            <td class='center'>{{ cbed?.min_remaining || 0 }}</td>
            <td class='center'>{{ detal.detal_kolvo + detal.shipments_kolvo *3 }}</td>
