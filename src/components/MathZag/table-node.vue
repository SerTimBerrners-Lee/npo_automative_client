...
export default {
  ...
  components: {},
  beforeCreate() {
    this.$options.components.DetalModal = require('@/components/BaseDetal/detal-modal').default;
    this.$options.components.ModalCbed = require('@/components/CbEd/cbed-modal').default;
    this.$options.components.ModalProduct = require('@/components/BaseProduct/product-modal').default;
  },
  methods: {
    setDetals(detal, e) {
      this.setTr(e);
