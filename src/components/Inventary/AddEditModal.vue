<template>
  <div class="right-menu-modal">
    ...
    <div :class='destroyModalRight'>
      <div :style="hiddens" >
        <div v-if="parametrs.inventary == 'TYPE'">
          <h3>{{ titleapp }} типа непроизв. техники и инвентаря</h3>
          <div class="block">
        ...
        <p v-if='parametrs.parent'>
          ...
          <span>{{ parametrs.parent.name }}</span>
        </p>
        <div v-if="parametrs.inventary == 'PODTYPE'">
          <h3>{{ titleapp }} подтипа непроизв. техники и инвентаря</h3>
          <div class="block">
            <p class='p_modal_name'> 
              <span>Наименование: </span>
              <input type="text" v-model.trim='inputs'>
