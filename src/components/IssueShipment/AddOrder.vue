...
import BaseBuyer from '@/components/BaseBuyer/ListBuyer';
import DetalModal from '@/components/BaseDetal/DetalModal';
import { mapActions, mapGetters, mapMutations } from 'vuex';
import ProductList from '@/components/BaseProduct/AllProductModal';
...
import BaseProductModal from '@/components/BaseProduct/BaseProductAllModal';
